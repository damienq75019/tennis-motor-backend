...
class ApiTennisDailyBuilder:
    ...
    def _round_wins_before_match(round_value: Any) -> int:
        ...
        This infers round-wins context. In STEP61, clay veto is audit-only
        and no longer blocks the official category, but the context is kept for display/audit. For a normal main draw, both players have the same
    ...
    def build_matches_for_day(self, target_day: str) -> Dict[str, Any]:
        ...
        for event in raw_events:
            ...
            match = {
                ...
                "qualifierDetectorPolicy": "api_tennis_round_wins_veto_audit_only_no_engine_block",
                ...
                "clayVetoBlockingDisabled": True,
                "vetoAuditPolicy": "round_wins_audit_only_no_engine_block_step61",
                ...
                "tournamentWinsPolicy": "api_tennis_round_to_main_draw_wins_veto_audit_only_no_engine_block",
        ...
        return {
            ...
            "audit": {
                ...
                "qualifierDetectorPolicy": "qualifier player-level remains audit only; round wins are audit-only and do not block engine",
                "standings": standings_audit,
