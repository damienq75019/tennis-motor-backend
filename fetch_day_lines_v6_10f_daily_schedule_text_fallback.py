...
# -*- coding: utf-8 -*-
"""
Tennis Motor - Fetch daily lines V6.10F DAILY SCHEDULE TEXT FALLBACK
...
Utilisation :
    py fetch_day_lines_v6_10f_daily_schedule_text_fallback.py today --backend-url http://127.0.0.1:8000
    py fetch_day_lines_v6_10f_daily_schedule_text_fallback.py tomorrow --backend-url http://127.0.0.1:8000
    py fetch_day_lines_v6_10f_daily_schedule_text_fallback.py today --backend-url http://127.0.0.1:9
...
MODE = "V6_10F_DAILY_SCHEDULE_TEXT_FALLBACK"
...
def main() -> int:
    ...
    audit.append("source_policy=ATP_DAILY_SCHEDULE_TEXT_FALLBACK_ONLY")
