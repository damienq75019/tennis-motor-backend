...
# -*- coding: utf-8 -*-
"""
Tennis Motor - Fetch daily lines V6.10J DAILY SCHEDULE STRICT DATE KEEP ALL
...
Utilisation :
    py fetch_day_lines_v6_10j_daily_schedule_strict_date_keep_all.py today --backend-url http://127.0.0.1:8000
    py fetch_day_lines_v6_10j_daily_schedule_strict_date_keep_all.py tomorrow --backend-url http://127.0.0.1:8000
    py fetch_day_lines_v6_10j_daily_schedule_strict_date_keep_all.py today --backend-url http://127.0.0.1:9
...
MODE = "V6_10J_DAILY_SCHEDULE_STRICT_DATE_KEEP_ALL"
...
def main() -> int:
    ...
    audit.append("source_policy=ATP_DAILY_SCHEDULE_STRICT_DATE_KEEP_ALL_ONLY")
