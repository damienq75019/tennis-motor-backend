...
class PremiumHistorySyncer:
    ...
    def settle_day_from_sportradar(self, target_day: str, *, dry_run: bool = False, client: Optional[Any] = None) -> Dict[str, Any]:
        """Compatibility stub. STEP44 disables every Sportradar settlement path."""
        return {
            "status": "error",
            "provider": "api_tennis_only",
            "targetDay": target_day,
            "dryRun": dry_run,
            "errors": ["STEP44 : Sportradar est désactivé. Utilise settle_day_from_api_tennis."],
            "counts": {
                "pending_before": 0,
                "settled": 0,
                "voided": 0,
    ...
    def settle_pending_recent(self, *, days_back: int = 0, dry_run: bool = False, client: Optional[Any] = None, provider: str = "api_tennis") -> Dict[str, Any]:
        ...
        for day in dates:
            # STEP44 : API-Tennis obligatoire, même si un ancien appel envoie provider=sportradar.
