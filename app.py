...
app = FastAPI(title="Tennis Motor Backend Clean", version="step59-step56-audit-only")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
def calculate_from_matches(matches: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    return {
        ...
        "daily": {
            ...
            "contextPropagation": "clean_step49-clay-veto-restored_11_real_history_signals_placeholder_filter_round_wins_veto_active",
            "excludedPlayers": _excluded_analysis_names(),
...
def root() -> Dict[str, Any]:
    return {
        ...
        "version": "step59-step56-audit-only",
        "coreEngineVersion": "step49-clay-veto-restored",
...
def health() -> Dict[str, Any]:
    ...
    return {
        ...
        "version": "step59-step56-audit-only",
        "coreEngineVersion": "step49-clay-veto-restored",
        "step56Audit": "enabled_dark_audit_only",
        "step56AuditEndpoint": "/audit/step56/daily",
        "officialDecisionEngine": "step49-clay-veto-restored",
        "officialDecisionsMutatedByStep56": False,
        "historyYears": list(HISTORY_YEARS),
        ...
        "step56AuditPolicy": "dark_audit_only_no_history_write_no_decision_change_no_odds",
    }
...
def step56_audit_daily(day: str = Query("today"), provider: str = Query("api_tennis")) -> Dict[str, Any]:
    ...
    response["daily"]["step59Policy"] = "STEP56 audit-only; no official decision mutation; no history write; no odds used by STEP56."
    auditor = get_step56_auditor()
    auditor.enrich_response(response)
    response["status"] = "ok"
    return response
