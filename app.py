...
def odds_status() -> Dict[str, Any]:
    ...
    return {
        ...
        "serviceVersion": "step40-history-reconcile-all-categories",
    }
...
def sync_results2026_status() -> Dict[str, Any]:
    ...
    status["serviceVersion"] = "step40-history-reconcile-all-categories"
    return status
...
def sync_results2026_postgres_export() -> Dict[str, Any]:
    ...
    result["serviceVersion"] = "step40-history-reconcile-all-categories"
...
def sync_history_form_value(
    ...
    try:
        ...
        report["serviceVersion"] = "step40-history-reconcile-all-categories"
        return report
    except Exception as exc:
        return {
            "status": "error",
