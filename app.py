...
def odds_status() -> Dict[str, Any]:
    ...
    return {
        ...
        "serviceVersion": "step39-api-tennis-legacy-settle",
    }
...
def sync_results2026_status() -> Dict[str, Any]:
    ...
    status["serviceVersion"] = "step39-api-tennis-legacy-settle"
    return status
...
def sync_results2026_postgres_export() -> Dict[str, Any]:
    ...
    result["serviceVersion"] = "step39-api-tennis-legacy-settle"
...
def sync_history_form_value(
    ...
    try:
        ...
        report["serviceVersion"] = "step39-api-tennis-legacy-settle"
        return report
    except Exception as exc:
        return {
            "status": "error",
