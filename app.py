...
app = FastAPI(title="Tennis Motor Backend Clean", version="step61-refuse-value-veto-audit-only")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
def root() -> Dict[str, Any]:
    return {
        ...
        "coreEngineVersion": "step56-global-direct-prediction-official-with-refuse-value",
        "message": "Backend STEP61 : STEP56 officiel + Refuse Value Engine, veto terre battue en audit only, aucun appel Sportradar.",
