...
app = FastAPI(title="Tennis Motor Backend Clean", version="step49-clay-veto-restored")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
def root() -> Dict[str, Any]:
    return {
        ...
        "version": "step49-clay-veto-restored",
        "message": "Backend STEP49 : API-Tennis uniquement, veto terre battue réactivé via round wins. Aucun appel Sportradar en production.",
